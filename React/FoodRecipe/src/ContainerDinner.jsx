...
import corba from "./assets/img/corba.jpg";
import makarna from "./assets/img/makarna.jpg";

const ContainerDinner = () => {
  return (
    <div>
      <div className="mainContainer">
        <h2 className="title">Makarna</h2>
        <ul>
          <li>
      ...
      <div className="mainContainer">
        ...
        <img className="image" src={corba} alt="Resim gösterilemedi" />
      </div>
    </div>
  );
};

export default ContainerDinner;